...
public class vayra_k3 extends BaseCommandPlugin {
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, Map<String, MemoryAPI> memoryMap) {
		if (dialog == null) return false;
                ...
                ShipVariantAPI variant = Global.getSettings().getVariant("vayra_seraph_standard").clone();
                data.addShip(new ShipRecoverySpecial.PerShipData(variant, ShipRecoverySpecial.ShipCondition.GOOD, "KHS Holy Sword", "kadur_remnant", 0f));
