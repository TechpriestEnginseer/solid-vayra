...
public class vayra_forever_war extends BaseHullMod {
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        if (isForModSpec || Global.CODEX_TOOLTIP_MODE) {
            ...
            tooltip.addPara("• %s overload duration", 0f, Misc.getPositiveHighlightColor(), "-"+String.valueOf(Math.round((int) ((1f - OVERLOAD_REDUCTION) * 100)))+"%");
            tooltip.addPara("• %s top speed", 0f, Misc.getPositiveHighlightColor(), "+"+String.valueOf(Math.round(SPEED)));
            ...
            tooltip.addPara("• %s deceleration and turn handling", 0f, Misc.getNegativeHighlightColor(), "-"+String.valueOf(Math.round(MANEUVERABILITY * 100f)) + "%");
